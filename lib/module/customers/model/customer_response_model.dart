...
class CustomerResponseModel {
    ...
    CustomerResponseModel.fromJson(Map<String, dynamic> json) {
        ...
        if(json["data"] is List) {
            data = json["data"] == null ? null : (json["data"] as List).map((e) => CustomerResponseData.fromJson(e)).toList();
        }
    }
...
class CustomerResponseData {
    ...
    CustomerResponseData({this.id, this.accountId, this.userId, this.branchId, this.groupId, this.fullname, this.mobile, this.isMobileVarified, this.email, this.dob, this.billingCycle, this.status, this.createdBy, this.createdDate, this.updatedBy, this.updatedDate, this.address, this.customerFcm});
