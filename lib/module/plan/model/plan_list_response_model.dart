class PlanListResponseModel {
    ...
    String? response;
    String? message;
    List<PlanListResponseData>? data;

    PlanListResponseModel({this.status, this.response, this.message, this.data});
    ...
    PlanListResponseModel.fromJson(Map<String, dynamic> json) {
        ...
        if(json["data"] is List) {
            data = json["data"] == null ? null : (json["data"] as List).map((e) => PlanListResponseData.fromJson(e)).toList();
        }
    }
...
class PlanListResponseData {
    ...
    PlanListResponseData({this.id, this.customerId, this.userId, this.branchId, this.title, this.amount, this.emiType, this.noOfEmi, this.image, this.notes, this.createdDate, this.updatedDate});

    PlanListResponseData.fromJson(Map<String, dynamic> json) {
