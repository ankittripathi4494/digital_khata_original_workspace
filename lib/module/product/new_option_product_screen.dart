...
class NewOptionProductScreen extends StatefulWidget {
  late Map<String, dynamic> argus;
  NewOptionProductScreen({super.key, required this.argus});

  @override
  State<NewOptionProductScreen> createState() => _NewOptionScreenState();
}

class _NewOptionScreenState extends State<NewOptionProductScreen> {
  ...
  fetchOptionDetails() {
    if (widget.argus.containsKey("varientOption")) {
      setState(() {
        ...
        productUnitListResponseData = ((widget.argus["varientOption"]
                    as Map<String, dynamic>)['productUnit'] ==
                null)
            ? null
            : ((widget.argus["varientOption"]
                    as Map<String, dynamic>)['productUnit']
                as ProductUnitListResponseData);
        ...
        onTap: () {
          if (widget.argus.containsKey("varientOption")) {
            ...
            if (productNameController.text.isNotEmpty) {
              ...
              EssentialWidgetsCollection.showErrorSnackbar(context,
                  description: "Please enter option name to save");
            }
          }
        },
        child: Container(
