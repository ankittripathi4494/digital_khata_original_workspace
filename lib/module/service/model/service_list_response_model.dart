...
class ServiceListResponseModel {
    ...
    String? response;
    String? message;
    List<ServiceListResponseData>? data;

    ServiceListResponseModel({this.status, this.response, this.message, this.data});

    ServiceListResponseModel.fromJson(Map<String, dynamic> json) {
        ...
        if(json["data"] is List) {
            data = json["data"] == null ? null : (json["data"] as List).map((e) => ServiceListResponseData.fromJson(e)).toList();
        }
    }
...
class ServiceListResponseData {
    ...
    ServiceListResponseData({this.id, this.customerId, this.branchId, this.userId, this.productName, this.modifierId, this.discountId, this.taxId, this.description, this.images, this.type, this.createdOn, this.updatedOn, this.itemCount, this.totalPrice});
