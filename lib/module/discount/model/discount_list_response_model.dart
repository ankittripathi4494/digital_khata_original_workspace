...
class DiscountListResponseModel {
  ...
  String? response;
  String? message;
  List<DiscountListResponseData>? data;

  DiscountListResponseModel(
      {this.status, this.response, this.message, this.data});

  DiscountListResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json["data"] is List) {
      data = json["data"] == null
          ? null
          : (json["data"] as List)
              .map((e) => DiscountListResponseData.fromJson(e))
              .toList();
    }
  }
...
class DiscountListResponseData {
  String? id;
  String? customerId;
  String? branchId;
  String? userId;
