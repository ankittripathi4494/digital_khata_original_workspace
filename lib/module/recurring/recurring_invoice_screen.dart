// ignore_for_file: must_be_immutable, unused_field, unused_local_variable, unnecessary_to_list_in_spreads
...
class RecurringInvoiceScreen extends StatefulWidget {
  ...
  RecurringInvoiceScreen({super.key, required this.argus});
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(right: screenSize.width * 0.29),
                        ...
                        showModalBottomSheet<void>(
                          ...
                          builder: (BuildContext context) {
                            List<Map<String, dynamic>> options = [
                              ...
                              {'text': 'Service', 'isChecked': false},
                              {'text': 'Custom Amount', 'isChecked': false},
                            ];
