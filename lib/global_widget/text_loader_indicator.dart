...
class TextLoaderIndicator extends StatefulWidget {
  final double size;
  final Duration duration;
  final Color mainColor;
  final Color secondaryColor;
  const TextLoaderIndicator({
    super.key,
    this.size = 60,
  ...
  @override
  State<TextLoaderIndicator> createState() => _TextLoaderIndicatorState();
}

class _TextLoaderIndicatorState extends State<TextLoaderIndicator> with SingleTickerProviderStateMixin {
